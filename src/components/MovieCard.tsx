            ...
            <div className="px-4 pt-4 pb-3 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                <motion.button
                  ...
                  title="Play"
                  className="w-10 h-10 rounded-full bg-primary flex items-center justify-center hover:bg-primary/85 transition-all duration-200 hover:scale-110 neon-glow"
                >
                ...
                <motion.button
                  ...
                  className="w-10 h-10 rounded-full border-2 border-muted-foreground/40 flex items-center justify-center hover:border-foreground transition-all duration-200 hover:scale-110 bg-background/30"
                >
                ...
                <motion.button
                  ...
                  title="More Info"
                  className="w-10 h-10 rounded-full border-2 border-muted-foreground/40 flex items-center justify-center hover:border-foreground transition-all duration-200 hover:scale-110 bg-background/30 ml-auto"
                >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-primary font-extrabold text-base">{movie.match || 85}% Match</span>
                  {movie.maturity && (
